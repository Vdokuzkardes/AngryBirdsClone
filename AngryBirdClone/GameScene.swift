...
class GameScene: SKScene,SKPhysicsContactDelegate, UITextFieldDelegate {
 ...
 /*
        ...
        birdSelect = SKSpriteNode(texture: texture)
        birdSelect.position = CGPoint(x: -self.frame.width / 4, y: 0)
        birdSelect.size = CGSize(width: 55, height: 55)
        birdSelect.zPosition = 1
        self.addChild(birdSelect)
        */
        ...
        let boxTexture = SKTexture(imageNamed: "moss")
